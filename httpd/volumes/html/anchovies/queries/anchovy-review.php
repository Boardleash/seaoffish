...
//var_dump($confirm, $date, $review, $anchovy_tin);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  //Set up an SQL query
  $sql = "insert into anchovy_ratings(anchovy_id,review,rating,date) values(?,?,?,?)";
  ...
  mysqli_stmt_bind_param($stmt, "isis", $anchovy_id, $review, $rating, $date);
