...
$mackerel_index = filter_input(INPUT_POST, "mackerel", FILTER_VALIDATE_INT);
...
//var_dump($confirm, $mackerel_index);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  //Set up an SQL query
  $sql = "update mackerel set consumed=consumed+1 where id=?";
  ...
  mysqli_stmt_bind_param($stmt, "i", $mackerel_index);
