...
//var_dump($confirm, $date, $review, $mackerel_tin);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  //Set up an SQL query
  $sql = "insert into mackerel_ratings(mackerel_id,review,rating,date) values(?,?,?,?)";
  ...
  mysqli_stmt_bind_param($stmt, "isis", $mackerel_id, $review, $rating, $date);
