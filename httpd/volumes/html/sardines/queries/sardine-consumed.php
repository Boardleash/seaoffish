...
$sardine_index = filter_input(INPUT_POST, "sardines", FILTER_VALIDATE_INT);
...
//var_dump($confirm, $sardine_index);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  //Set up an SQL query
  $sql = "update sardines set consumed=consumed+1 where id=?";
  ...
  mysqli_stmt_bind_param($stmt, "i", $sardine_index);
